 ...
 * modification for STM32f408: Husamuldeen <https://github.com/hussamaldean>
...
OLEDBuffer oledBufferCreate(const int oledBufferSize){
	assert((oledBufferSize <= 20) && "Error: requested oledBufferSize is greater than 20");

	OLEDBuffer oledBuffer = {oledBufferSize};
